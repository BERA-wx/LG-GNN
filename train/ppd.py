...
parser.add_argument('--hidden_gat', type=int, default=[128, 64],
                    help='Number of hidden units of GAT.')
...
parser.add_argument('--eta', type=float, default=0.6, help='Weight of contrastive loss.')
...
# Load data
# p: Home1(0.95), Home2(0.95)
# batch_size: Home1(2000), Home2(2000)
datasets = load_data(dataset_name='PPD1', p=0.95, batch=2000)
for idx, batch in enumerate(datasets):
    ...
    model = LG_GNN(in_features=features.shape[1],
                   ...
                   k_l=0.2,  # PPD1(0.2) PPD2(0.2)
                   k_g=0.3,  # PPD1(0.3) PPD2(0.8)
                   dropout=args.dropout,
                   num_unique_values=256,
                   embed_dim=8,  # PPD1(8) PPD2(16)
